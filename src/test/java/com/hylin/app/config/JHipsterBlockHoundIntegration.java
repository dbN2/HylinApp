...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.hylin.app.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.hylin.app.security.DomainUserDetailsService", "createSpringSecurityUser");
